...
def prepare_extraction_comparison_rows(raw_dir: str = "data/raw", extraction_mode: str = "auto") -> list[list]:
...
def write_extraction_comparison_csv(out_csv: str | Path, raw_dir: str = "data/raw", extraction_mode: str = "auto") -> Path:
    rows = prepare_extraction_comparison_rows(raw_dir=raw_dir, extraction_mode=extraction_mode)
