...
PR #2 adds a finite toy chain-certificate model inspired by Erdős #1196 together with a staged formalization roadmap.
This second track complements the hopfion benchmark by adding antichain/path exclusivity tools for endpoint-selection reasoning.
